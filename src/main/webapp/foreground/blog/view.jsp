...
<script src="${pageContext.request.contextPath}/yanzhengma/js/jquery.js"></script>
<script src="${pageContext.request.contextPath}/yanzhengma/js/verifyCode.js"></script>
<script src="${pageContext.request.contextPath}/yanzhengma/js/Particleground.js"></script>
...
$(function(){
	//放表情
    $("#message_face").jqfaceedit({txtAreaObj:$("#Content"),containerObj:$('#container'),top:-215,left:-381});
	 //显示表情
				...
				<c:forEach var="comment" items="${commentList }" varStatus="status">
						<c:choose>
							<c:when test="${status.index<10 }">
								<div class="comment">
									<span><font>${status.index+1 }楼<%-- &nbsp;&nbsp;&nbsp;&nbsp;${comment.userIp } --%>：</font><font class="show_e">${comment.content }</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[&nbsp;<fmt:formatDate value="${comment.commentDate }" type="date" pattern="yyyy-MM-dd HH:mm:ss"/>&nbsp;]</span>
								</div>								
							</c:when>
							<c:otherwise>
...
<div class="data_list" >
	...
	<div class="publish_comment">
			<div>
				<td>
								<div id="container">
								<a href="JavaScript:void(0)" id="message_face"><img src="${pageContext.request.contextPath}/emotions/1.gif"/></a>
			...
			<div>
				 ...
				 <textarea style="width: 100%" rows="3" id="Content" name="content" placeholder="来说两句吧..." maxlength="600" ></textarea>
				 <div id="note" class="note">
            <font color="#777"><font color="red">*强哥提醒您：</font>在这里写入您对此篇文章的评论，请勿输入不良文字等</font>
        </div>
			</div>
			<div class="verCode">
			...
			<%--  <input type="text" id="imageCode" name="imageCode" placeholder="验证码" maxlength="4" class="login_txtbx">
   			 <img id="imgObj" title="看不清，换一张" src="${pageContext.request.contextPath}/image/drawImage.do" onclick="changeImg()" /> --%>
			</div>
