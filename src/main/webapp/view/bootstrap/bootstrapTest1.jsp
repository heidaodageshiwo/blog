...
<script src="${pageContext.request.contextPath}/staticfenye/static/js/bootstrap/js/bootstrap.min.js"></script>
...
<body>
	...
	<script type='text/javascript'>    
        ...
        function buildTable(userName,pageNumber,pageSize,currentPageNumber) {
        	 var url =  urlRootContext+"/fenye" + "/list.do"; //请求的网址
        	 //alert(url);
...
/*                     $("#tableBody").append('<td >' + '<a href="${pageContext.request.contextPath}/fenye/list123.do">'+this.userEmail + '</a>'+'</td>'); */
                    $("#tableBody").append('</tr>');
             	    });  
             	    } else {             	            	
