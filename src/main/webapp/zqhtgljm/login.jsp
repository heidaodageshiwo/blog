...
<body>
	<h1>App Sign In Form</h1>
		<div class="app-cam">
			<div class="cam"><img src="${pageContext.request.contextPath}/login/images/cam.png" class="img-responsive" alt="" /></div>
			<form action="${pageContext.request.contextPath}/blogger/login.do" method="post" onsubmit="return checkForm()">
			<INPUT id="userName" name="userName" class="ipt" type="text"  value="${blogger.userName }"> 
				...
				<INPUT id="password" name="password" class="ipt"  type="password"  value="${blogger.password }"> 
