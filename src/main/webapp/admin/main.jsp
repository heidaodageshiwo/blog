...
<title>Powered by:Zhangqiang 个人博客系统  版权所有</title>
...
<div region="center">
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			<div align="center" style="padding-top: 100px"><font color="red" size="10"> 欢迎${currentUser.userName }使用 </font></div>
		</div>
	</div>
</div>
<div region="west" style="width: 200px" title="导航菜单" split="true">
	<div class="easyui-accordion" data-options="fit:true,border:false">
		<div title="常用操作" data-options="selected:true,iconCls:'icon-item'" style="padding: 10px">
			...
			<a href="javascript:openTab('文件上传列表','FileUpload.jsp','icon-review')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-review'" style="width: 150px">文件上传列表</a>
			<a href="javascript:openTab('文件上传','FileUploadUpload.jsp','icon-review')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-review'" style="width: 150px">文件上传</a>
		</div>
...
<div region="south" style="height: 25px;padding: 5px" align="center">
	Copyright © 2012-2016 Powered by:Zhangqiang 个人博客系统  版权所有
</div>
