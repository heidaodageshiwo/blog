...
<table id="dg" title="文件上传管理" class="easyui-datagrid"
   ...
   <thead>
   	<tr>
   		...
   		<th field="beizhu" width="200" align="center">备注</th>
   		<th field="dizhi" width="50" align="center">地址</th>
   		<th field="xzl" width="50" align="center">下载量</th>
   	</tr>
   </thead>
 </table>
 <div id="tb">
